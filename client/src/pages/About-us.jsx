        ...
        <div className="row">
          ...
          <div className="col-5 p-3 m-2 border rounded-xxl shadow">
            ...
            <p className="fs-5">
              ...
              facilis autem magni, sit voluptatem rem dignissimos dolor
              doloremque beatae reprehenderit repellendus cum, molestias quidem
              adipisci. Repudiandae qui odio sit vel.
            </p>
          </div>
        </div>
      </div>
